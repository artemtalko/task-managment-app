...
function AddEditBoardModal({ setBoardModalOpen, type }) {
  ...
  return (
    ...
    >
      {/* modal section */}
      <div className="scrollbar-hide overflow-scroll max-h-[95vh] bg-white dark:bd-[#2b2c37] text-black dark:text-white font-bold shadow-md shadow-[#364e7e1a] max-w-md mx-auto w-full px-8 py-8 rounded-xl">
